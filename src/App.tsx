...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F0] flex flex-col lg:flex-row items-center justify-center font-sans relative overflow-hidden p-2 lg:p-6 select-none">
      ...
      {/* Main Interactive Smartphone Container Mockup */}
      <div className="w-full max-w-md bg-[#F5F5F0] border-4 border-[#0B3014] rounded-[36px] shadow-[12px_12px_0px_0px_#0B3014] relative overflow-hidden flex flex-col z-10 transition-all duration-300"
           style={{ height: "860px" }}>
            ...
            <div className="p-4 space-y-4 fade-in pt-12">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  ...
                  />
                  <div>
                    <h3 className="text-xs font-bold text-slate-800">Segun Alao</h3>
                    <p className="text-[10px] text-[#00450d] font-bold">Jos Highlands Hub Farmer</p>
                  </div>
                </div>

                <span className="text-[9.5px] bg-emerald-50 text-emerald-800 font-extrabold px-2.5 py-1 rounded-full border border-emerald-100">
                  ID: #FJ-7023
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                <div className="bg-white p-3 rounded-2xl border border-slate-100 shadow-sm">
                  <p className="text-[9px] text-slate-400 font-bold uppercase">Total Earnings</p>
                  <p className="text-base font-black text-[#00450d] mt-1">₦245,000</p>
                  <p className="text-[8.5px] text-slate-400 mt-0.5">Paid direct to bank</p>
                </div>

                <div className="bg-white p-3 rounded-2xl border border-slate-100 shadow-sm">
                  <p className="text-[9px] text-slate-400 font-bold uppercase">Products Listed</p>
                  <p className="text-base font-black text-slate-800 mt-1">8 Harvests</p>
                  <p className="text-[8.5px] text-emerald-700 font-bold mt-0.5">3 actively listed</p>
                </div>

                <div className="bg-white p-3 rounded-2xl border border-slate-100 shadow-sm">
                  <p className="text-[9px] text-slate-400 font-bold uppercase">Active Orders</p>
                  <p className="text-base font-black text-amber-600 mt-1">3 Pending</p>
                  <p className="text-[8.5px] text-slate-400 mt-0.5">Transit vehicle booked</p>
                </div>

                <div className="bg-white p-3 rounded-2xl border border-slate-100 shadow-sm">
                  <p className="text-[9px] text-slate-400 font-bold uppercase">Freshness Rating</p>
                  <p className="text-base font-black text-[#00450d] mt-1">4.9 / 5.0</p>
                  <p className="text-[8.5px] text-slate-400 mt-0.5">No bruising claims</p>
                </div>
              </div>

              {/* Realtime soil and water compliance check */}
              <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-sm space-y-3">
                <h4 className="text-xs font-bold text-slate-700 font-headline">Compliance Checklist Status</h4>
                <div className="space-y-2">
                  <div className="flex justify-between items-center bg-slate-50 p-2 rounded-xl text-[10px]">
                    <span className="font-medium text-slate-500">Pesticide residue test</span>
                    <span className="text-emerald-700 font-extrabold uppercase">PASS (0.00 ppm)</span>
                  </div>
                  <div className="flex justify-between items-center bg-slate-50 p-2 rounded-xl text-[10px]">
                    <span className="font-medium text-slate-500">Soil Organic Matter audit</span>
                    <span className="text-[#00450d] font-extrabold uppercase">PASS (94% score)</span>
                  </div>
                  <div className="flex justify-between items-center bg-[#f9f9f9] p-2 rounded-xl text-[10px]">
                    <span className="font-medium text-slate-500">Logistics dispatch seal</span>
                    <span className="text-amber-600 font-extrabold uppercase">ACTIVE (Cold chain verified)</span>
                  </div>
                </div>
              </div>

              {/* Farmer Quick Actions list */}
              <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden text-xs pb-4">
                <div className="p-3 border-b border-slate-100 font-bold text-slate-700 bg-slate-50">
                  Farmer Quick Actions
                </div>
                <div className="divide-y divide-slate-100">
                  <div className="p-3 flex items-center justify-between hover:bg-slate-50 cursor-pointer text-slate-600">
                    <span className="flex items-center gap-2">
                      <span className="material-symbols-outlined text-slate-400">upload_file</span>
                      Upload New Fresh Harvest Batch
                    </span>
                  ...
                  <div className="p-3 flex items-center justify-between hover:bg-slate-50 cursor-pointer text-slate-600">
                    <span className="flex items-center gap-2">
                      <span className="material-symbols-outlined text-slate-400">clinical_trial</span>
                      Submit Weekly Soil PH Level Certificate
                    </span>
                    <span className="material-symbols-outlined text-slate-400">chevron_right</span>
                  </div>
                  ...
                  <div className="p-3 flex items-center justify-between hover:bg-slate-50 cursor-pointer text-slate-600">
                    <span className="flex items-center gap-2">
                      <span className="material-symbols-outlined text-slate-400">hvac</span>
                      Request Hub Transit Temperature Pickup
                    </span>
                    <span className="material-symbols-outlined text-slate-400">chevron_right</span>
                  </div>
                </div>
